...
export const Category = () => {
  ...
  const itemImages = {
    apples: "/src/assets/apple.jpg", //D:\projects\company\frontend
    bananas: "/src/assets/banana.jpg",
    guava:"/src/assets/Guava.jpg",
    apricot:"/src/assets/Apricot.jpg",
    rambutan:"/src/assets/Rambutan.jpg",
    mango:"/src/assets/Mango.jpg",
    cherry:"/src/assets/Cherry.jpg",
    pineapple:"/src/assets/Pineapple.jpg",
    potato: "/src/assets/potato.jpg",
    grape: "/src/assets/graphs.jpg",
    carrots: "/src/assets/corrat.jpg",
    chicken: "/src/assets/chicken.jpg",
    fish: "/src/assets/fish.jpg",
    mutton: "/src/assets/mutton.jpg",
    chips: "/src/assets/chips.jpg",
    biscuits: "/src/assets/biuscut.jpg",
    namkeen: "/src/assets/namkeen.jpg",
    Samosa:"/src/assets/Samosa.jpg",
    Pakora:"/src/assets/Pakora.jpg",
    cutlet:"/src/assets/Cutlet.jpg",           
    dhokla:"/src/assets/Dhokla.jpg",
    misalpav:"/src/assets/MisalPav.jpg",
    panipuri:"/src/assets/PaniPuri.jpg",
    vadapav:"/src/assets/VadaPav.jpg",
    eggpuff:"/src/assets/EggPuff.jpg",
    Jalebi:"/src/assets/Jalebi.jpg",
    upma:"/src/assets/Upma.jpg",
    beaf:"/src/assets/beaf.jpg",
    chickentikkamasala:"/src/assets/beaf.jpg",
    chickenchettinad:"/src/assets/chedinad.jpg" //D:\projects\company\frontend\src\assets\chedinad.jpg
  };
  const itemPrices = {
    Apples: 50,
    Bananas: 30,
